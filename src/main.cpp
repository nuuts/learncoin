...
uint256 hashGenesisBlock("0xa66fda3d91a4f5a2e241714ad4f6d6d37aed5780699ff5b1ad8a7c6c627b4d20");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa66fda3d91a4f5a2e241714ad4f6d6d37aed5780699ff5b1ad8a7c6c627b4d20");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Saruul";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1502775985;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1216581;
        ...
        assert(block.hashMerkleRoot == uint256("0x0c7b4dbb7ced44784b3e08b66a33d6b6c0bd63efe1100d24bb47c84c8a0485a1"));
